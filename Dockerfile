...
# Install SGLang Nightly and Qwen 3.6 dependencies
# Pulling from GitHub ensures the --reasoning-parser qwen3 flag is fully supported
...
# This maps the new 'qwen35' and 'qwen3' tags to the existing Qwen2 logic in Transformers
...
# Force thinking preservation at the engine level
